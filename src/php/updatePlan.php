<?php
// INPUT: {ttl, startAt, endAt, bgClr, fontClr, text, planId, groupId }
// OUTPUT: state
...
// Update event
if( $result == "" ) {
  $sql = "UPDATE plans SET ttl = :ttl, bg_clr = :bg_clr, font_clr = :font_clr, start_at = :start_at, end_at = :end_at, detail = :detail, update_at = :update_at, update_by = :update_by WHERE uniq_id = :uniq_id";
  $res = $PDO->prepare($sql);
  $params = array(
    ":ttl" => $datas[0],
    ":bg_clr" => $datas[3],
