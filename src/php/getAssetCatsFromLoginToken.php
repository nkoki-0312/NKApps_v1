<?php
// INPUT: None
// OUTPUT: [uniq_id, group_id, user_id, name, type, amount, clr, group_name, user_state]
//
...
foreach( $res as $resFor ) {
  ...
  if( $resFor[1] == "self" ) {
    ...
    foreach( $resGetGroupName as $resGetGroupNameFor ) {
      $result[$count][7] = $resGetGroupNameFor[0];
    }
    ...
    foreach( $resGetState as $resGetStateFor ) {
      $result[$count][8] = $resGetStateFor[0];
    }
  }
